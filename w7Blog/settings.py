"""
Django settings for w7Blog project.
...
SECRET_KEY = 'django-insecure-+qcuuah-xntb*b3&$pc-#iwc!0&^rgwsq8dylp7fyx5v+o46$z'
...
ROOT_URLCONF = 'w7Blog.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['w7Blog/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'w7Blog.wsgi.application'
